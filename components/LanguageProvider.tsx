...
export const translations = {
  en: {
    ...
    landing: {
      ...
      agentsBody:
        "FlowCrew works best when the agents stay separated: Jackie clarifies, Dex classifies, Nora evaluates urgency and risk, Milo handles replies and follow-ups.",
      agentCards: {
        jackie: {
        ...
        dex: {
          ...
          tagline:
            "Adds tags, category, priority, status, and CRM notes.",
        },
      },
    ...
    trial: {
      ...
      previewBody:
        "When you run the Crew, the raw message is sent securely to the server and analyzed by Gemini. FlowCrew does not save it in this prototype.",
      previewSteps: [
        ["Jackie", "Cleans the conversation and spots missing info"],
        ["Dex", "Adds tags, category, priority, status, and CRM-style notes"],
        ["Nora", "Evaluates urgency, lead quality, risk, and next actions"],
        ["Milo", "Drafts a reply and follow-up for your approval"],
      ],
      localOnly: "Gemini analysis runs server-side. Your API key never reaches the browser.",
      used: "Free trial used: 1/1 conversation",
      analysisError: "Gemini could not analyze this conversation. Please try again.",
      replyCopied: "Reply copied. Review it before sending.",
      copyError: "I could not copy the reply. Select the text and copy it manually.",
      resultsLabel: "Crew output",
      resultsTitle: "Your client conversation is organized",
      jackieTitle: "Jackie cleaned the conversation",
      dexTitle: "Dex classified and logged it",
      noraTitle: "Nora evaluated urgency and next actions",
      miloTitle: "Milo prepared a reply and follow-up",
      ...
      profitabilitySignal: "Lead quality",
  ...
  it: {
    ...
    landing: {
      ...
      agentCards: {
        ...
        dex: {
          role: "Classificazione Lead",
          tagline:
            "Aggiunge tag, categoria, priorità, stato e nota CRM.",
        },
      },
    ...
    trial: {
      ...
      previewBody:
        "Quando avvii la Crew, il messaggio grezzo viene inviato in modo sicuro al server e analizzato da Gemini. FlowCrew non lo salva in questo prototipo.",
      previewSteps: [
        ["Jackie", "Pulisce la conversazione e trova le info mancanti"],
        ["Dex", "Aggiunge tag, categoria, priorità, stato e nota CRM"],
        ["Nora", "Valuta urgenza, qualità del lead, rischio e prossime azioni"],
        ["Milo", "Prepara risposta e follow-up da approvare"],
      ],
      localOnly: "L'analisi Gemini gira sul server. La chiave API non arriva mai al browser.",
      used: "Prova gratuita usata: 1/1 conversazione",
      analysisError: "Gemini non ha analizzato la conversazione. Riprova.",
      replyCopied: "Risposta copiata. Controllala prima di inviarla.",
      copyError: "Non riesco a copiare la risposta. Seleziona il testo e copialo manualmente.",
      ...
      dexTitle: "Dex ha classificato e registrato",
      noraTitle: "Nora ha valutato urgenza e prossime azioni",
      miloTitle: "Milo ha preparato risposta e follow-up",
      ...
      opportunityStatus: "Stato lead",
      profitabilitySignal: "Qualità lead",
